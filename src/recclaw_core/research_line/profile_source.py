...
class ResearchProfileSourceV1:
    ...
    def _candidate_identity(
        ...
        *,
        ...
        defaults = {
            ...
            "parent_id": exact_parent_candidate_id(proposal),
        ...
        if "candidate_source_sha256" not in identity:
            source_digest = getattr(proposal, "candidate_source_sha256", None)
    ...
    def _candidate_parent(binding: Any) -> str | None:
        proposal = getattr(binding, "proposal", None)
        parent = exact_parent_candidate_id(proposal)
        if parent is None:
            return None
    ...
    def _actual_candidate_digests(
        ...
        if isinstance(execution, Mapping):
            ...
            execution_source_digest = execution.get(
                "candidate_source_sha256",
                execution.get("entrypoint_source_sha256"),
            )
