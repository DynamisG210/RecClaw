"""Fresh V15 chain Pilot for the qualified native-Linux backend."""
...
from .campaign_pilot_v14 import (
...
V15_PILOT_SEARCH_SEED = 9217
V15_PILOT_ROUNDS_PER_ARM = 5
V15_PILOT_EXPERIMENT_ID = (
    "HELIX-ABC-DEVELOPMENT-CAMPAIGN-PILOT-9217-V15"
)
V15_PILOT_ASSIGNMENT_NONCE = "M6G-V15-PILOT-9217-OPAQUE-V1"
V15_EXECUTABLE_PROFILE_DIGEST = V14_EXECUTABLE_PROFILE_DIGEST


def v15_arm_policies() -> tuple[ArmPolicyV1, ArmPolicyV1, ArmPolicyV1]:
    return v14_arm_policies()


@dataclass(frozen=True, slots=True)
class V15PilotStoreContractV1:
    experiment_id: str
    ...
    @classmethod
    def create(cls) -> "V15PilotStoreContractV1":
        base = default_experiment_contract()
        policies = v15_arm_policies()
        ...
        if (
            ...
            raise PreCanaryInvariantError(
                "V15 runtime profile is not the frozen 66-semantics release"
            )
        payload = {
            ...
            "experiment_id": V15_PILOT_EXPERIMENT_ID,
            "formal_acceptance": False,
            "main_eligibility": False,
            "ordinary_execution_seed": base.ordinary_execution_seed,
            "scheduled_slots_per_arm_seed": V15_PILOT_ROUNDS_PER_ARM,
            "search_seeds": [V15_PILOT_SEARCH_SEED],
        }
        return cls(
            experiment_id=V15_PILOT_EXPERIMENT_ID,
...
def v15_pilot_guard_context() -> GuardContext:
    ...
    return GuardContext(
        claim={
            **claim,
            "claim_id": "CLAIM-M6G-V15-PILOT-9217",
        ...
        current_evidence={
            **evidence,
            "snapshot_id": "M6G-V15-PILOT-9217-EMPTY",
            "claim_id": "CLAIM-M6G-V15-PILOT-9217",
            "protocol_id": protocol["protocol_id"],
        },
    )
...
class V15PilotOrchestratorV1(MetaV17PilotOrchestratorV1):
    def __init__(
        self,
        root: Path,
        *,
        ...
        if (
            ...
            raise PreCanaryInvariantError(
                "V15 Pilot requires the direct pinned Main Original path"
            )
        if broker.campaign_meta_runtime is not meta_runtime:
            raise PreCanaryInvariantError(
                "V15 Broker and orchestrator require the same V19 runtime"
            )
        super().__init__(
            root,
            broker=broker,
            ...
            _contract=V15PilotStoreContractV1.create(),
            _assignment_nonce=V15_PILOT_ASSIGNMENT_NONCE,
            _guard_context=v15_pilot_guard_context(),
    ...
    def run_pilot(
        ...
        return tuple(
            ...
            for round_index in range(1, V15_PILOT_ROUNDS_PER_ARM + 1)
        )
...
__all__ = [
    ...
    "V15PilotOrchestratorV1",
    "V15PilotStoreContractV1",
    "v15_arm_policies",
    "v15_pilot_guard_context",
]
