...
Candidate config and registry wiring are generated by the promotion or
implementation scripts. Proposal implementations should not write configs,
registry files, notes, or package `__init__.py` files directly.
