...
class AgentConfig:
    ...
    plateau_weak_family_ceiling: float = 0.2671
    ...
    lightgcn_baseline_reference: float = 0.2671
...
class RecClawAgent:
    ...
    def act(
        ...
        params: dict[str, Any],
        *,
        execution_purpose: str = "ordinary",
    ) -> dict[str, Any]:
        ...
        cmd.extend(["--execution-purpose", execution_purpose])
    ...
    def _has_strong_algorithm_signal(self) -> bool:
        ...
        return best is not None and best >= self.config.lightgcn_baseline_reference
    ...
    def _build_agent_state_summary(self) -> dict[str, Any]:
        ...
        summary = {
            ...
            "algorithm_first_targets": {
                ...
                "lightgcn_baseline_reference": self.config.lightgcn_baseline_reference,
                ...
                "guidance": (
                    "If best_metric_so_far is below lightgcn_baseline_reference, prioritize propose_algorithm, "
        ...
        context = {
            **self._llm_proposal_context(),
            ...
            "instruction": (
                ...
                "below lightgcn_baseline_reference. Prefer tune_after_algorithm_success only after an algorithmic candidate "
                "has crossed lightgcn_baseline_reference. Prefer multi_seed_verify only when there is an unverified keep "
    ...
    def run_seed_validation(
        ...
        for seed in self.config.validation_seeds:
            ...
            action_out = self.act(candidate, seed_params, execution_purpose="confirmation")
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=float,
        default=float(os.environ.get("RECCLAW_PLATEAU_WEAK_FAMILY_CEILING", "0.2671")),
