#!/usr/bin/env python3
"""Freeze V13's content-bound Campaign training runtime release V5."""
...
def main() -> None:
    base = json.loads(
        (RESOURCE_ROOT / "training_runtime_release_v4.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    base["release_id"] = "TRAINING_RUNTIME_RELEASE_V5"
    ...
    base["package_owned_handler_registry_digest"] = sha256_digest(
        {
            ...
            "training_release_resource": "training_runtime_release_v5.json",
        }
    )
    output = RESOURCE_ROOT / "training_runtime_release_v5.json"
