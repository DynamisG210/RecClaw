...
from build_v23_gpu35_closure import activate_original_git_tool  # noqa: E402
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(
        prefix="recclaw-v23-original-probe-"
    ) as raw:
    ...
    preimage = {
        ...
        "record_schema": (
            "recclaw.v23-pinned-original-materialization-probe.v1"
        ),
