...
$localStdout = "\\wsl.localhost\Ubuntu\tmp\recclaw_v24_gpu35_ssh.stdout.log"
$localStderr = "\\wsl.localhost\Ubuntu\tmp\recclaw_v24_gpu35_ssh.stderr.log"
...
$remoteScript = @'
set -u
config=/dev/shm/recclaw_v24_llm_9226_runtime.md
supervisor_script=/dev/shm/recclaw_v24_supervisor_9226.sh
backend=/NAS2020/Workspaces/DMGroup/tingrangan/recclaw_gpu35_backend_v4_m6i
source=$backend/qualification_v16_v24/source
pilot_root=$backend/pilot_9226_v24
status=$backend/V24_PILOT_SUPERVISOR_STATUS.json
run_log=$backend/V24_PILOT_RUN.log
...
"$python" scripts/run_v24_pilot.py \
  --contract "$source/docs/research_line/continuous_program/V24_FROZEN_CHAIN_PILOT_CONTRACT.json" \
...
$remoteCommand = (
    "printf %s $encoded | base64 -d > /dev/shm/recclaw_v24_supervisor_9226.sh; " +
    "chmod 700 /dev/shm/recclaw_v24_supervisor_9226.sh; " +
    "bash /dev/shm/recclaw_v24_supervisor_9226.sh; " +
    "rc=`$?; rm -f /dev/shm/recclaw_v24_supervisor_9226.sh; exit `$rc"
)
