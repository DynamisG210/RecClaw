#!/usr/bin/env python3
"""Freeze Campaign Runtime V16 for current M6I bytes on gpu35."""
...
RELEASE_ID = "TRAINING_RUNTIME_RELEASE_V16"
RELEASE_RESOURCE = "training_runtime_release_v16.json"
BASE_RELEASE_RESOURCE = "training_runtime_release_v15.json"
LOCK_RESOURCE = "training_runtime_v16_lock.json"
BACKEND_CLASS = "LAB_GPU35_RTX3080_NATIVE_LINUX_V6_M6I_V24"
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError(
            "V16 must be frozen on one qualified gpu35 RTX 3080"
        )
