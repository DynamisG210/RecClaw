#!/usr/bin/env python3
"""Run the frozen V16 resource-closure recovery Pilot once."""
...
from freeze_v16_pilot_contract import (  # noqa: E402
    DEFAULT_OUTPUT,
    activate_original_git_tool,
    verify_v16_pilot_contract,
)
...
def execute(contract_path: Path, llm_api_config: Path) -> int:
    ...
    return execute_campaign_pilot(
        contract_path,
        llm_api_config,
        verify_contract=verify_v16_pilot_contract,
        meta_runtime_class=MetaV19CampaignRuntimeV1,
        orchestrator_class=V16PilotOrchestratorV1,
