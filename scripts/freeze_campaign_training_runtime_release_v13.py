#!/usr/bin/env python3
"""Freeze Campaign Runtime V13 for current M6I bytes on gpu35."""
...
RELEASE_ID = "TRAINING_RUNTIME_RELEASE_V13"
RELEASE_RESOURCE = "training_runtime_release_v13.json"
BASE_RELEASE_RESOURCE = "training_runtime_release_v9.json"
LOCK_RESOURCE = "training_runtime_v13_lock.json"
BACKEND_CLASS = "LAB_GPU35_RTX3080_NATIVE_LINUX_V3_M6I"
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError(
            "V13 must be frozen on one qualified gpu35 RTX 3080"
        )
