#!/usr/bin/env python3
"""Freeze the typed-rejection Campaign training runtime release V7."""
...
def main() -> None:
    base = json.loads(
        (RESOURCE_ROOT / "training_runtime_release_v6.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    base["release_id"] = "TRAINING_RUNTIME_RELEASE_V7"
    ...
    base["package_owned_handler_registry_digest"] = sha256_digest(
        {
            ...
            "training_release_resource": "training_runtime_release_v7.json",
        }
    )
    output = RESOURCE_ROOT / "training_runtime_release_v7.json"
