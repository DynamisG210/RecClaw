#!/usr/bin/env python3
"""Freeze Campaign Runtime V15 for current M6I bytes on gpu35."""
...
RELEASE_ID = "TRAINING_RUNTIME_RELEASE_V15"
RELEASE_RESOURCE = "training_runtime_release_v15.json"
BASE_RELEASE_RESOURCE = "training_runtime_release_v14.json"
LOCK_RESOURCE = "training_runtime_v15_lock.json"
BACKEND_CLASS = "LAB_GPU35_RTX3080_NATIVE_LINUX_V5_M6I_V23"
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError(
            "V15 must be frozen on one qualified gpu35 RTX 3080"
        )
