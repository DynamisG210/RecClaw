...
$localStdout = "\\wsl.localhost\Ubuntu\tmp\recclaw_v22_gpu35_ssh.stdout.log"
$localStderr = "\\wsl.localhost\Ubuntu\tmp\recclaw_v22_gpu35_ssh.stderr.log"
...
$remoteScript = @'
set -u
config=/dev/shm/recclaw_v22_llm_9224_runtime.md
supervisor_script=/dev/shm/recclaw_v22_supervisor_9224.sh
backend=/NAS2020/Workspaces/DMGroup/tingrangan/recclaw_gpu35_backend_v3_m6i
source=$backend/qualification_v14_v22/source
pilot_root=$backend/pilot_9224_v22
status=$backend/V22_PILOT_SUPERVISOR_STATUS.json
run_log=$backend/V22_PILOT_RUN.log
...
"$python" scripts/run_v22_pilot.py \
  --contract "$source/docs/research_line/continuous_program/V22_FROZEN_CHAIN_PILOT_CONTRACT.json" \
...
$remoteCommand = (
    "printf %s $encoded | base64 -d > /dev/shm/recclaw_v22_supervisor_9224.sh; " +
    "chmod 700 /dev/shm/recclaw_v22_supervisor_9224.sh; " +
    "bash /dev/shm/recclaw_v22_supervisor_9224.sh; " +
    "rc=`$?; rm -f /dev/shm/recclaw_v22_supervisor_9224.sh; exit `$rc"
)
