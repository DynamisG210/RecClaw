#!/usr/bin/env python3
"""Run the frozen V24 gpu35 backend-migration Pilot once."""
...
from build_v24_gpu35_closure import (  # noqa: E402
    DEFAULT_OUTPUT,
    activate_original_git_tool,
    verify_v24_pilot_contract,
)
from recclaw_core.experiments.helix_abc_v1.campaign_pilot_v24 import (  # noqa: E402
...
def execute(contract_path: Path, llm_api_config: Path) -> int:
    ...
    return execute_campaign_pilot(
        contract_path,
        llm_api_config,
        verify_contract=verify_v24_pilot_contract,
        meta_runtime_class=MetaV19CampaignRuntimeV1,
        orchestrator_class=V24PilotOrchestratorV1,
        search_seed=V24_PILOT_SEARCH_SEED,
        rounds_per_arm=V24_PILOT_ROUNDS_PER_ARM,
        version_label="V24",
    )
