#!/usr/bin/env python3
"""Run the frozen V23 gpu35 backend-migration Pilot once."""
...
from build_v23_gpu35_closure import (  # noqa: E402
    DEFAULT_OUTPUT,
    activate_original_git_tool,
    verify_v23_pilot_contract,
)
from recclaw_core.experiments.helix_abc_v1.campaign_pilot_v23 import (  # noqa: E402
...
def execute(contract_path: Path, llm_api_config: Path) -> int:
    ...
    return execute_campaign_pilot(
        contract_path,
        llm_api_config,
        verify_contract=verify_v23_pilot_contract,
        meta_runtime_class=MetaV19CampaignRuntimeV1,
        orchestrator_class=V23PilotOrchestratorV1,
        search_seed=V23_PILOT_SEARCH_SEED,
        rounds_per_arm=V23_PILOT_ROUNDS_PER_ARM,
        version_label="V23",
    )
